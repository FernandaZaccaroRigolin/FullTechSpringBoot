...
<body>
	...
	<div class="container borda">
		...
		<form action="/pedidos/novo" method="post">
			<div class="mb-3">
				<label class="form-label">Cliente:</label> <select name="cpf"
					class="form-select">
			...
			<div class="mb-3">
				<label class="form-label">Num. Pedido:</label> <input type="text"
					name="numeroPedido" class="form-control" />
			</div>

			<div class="mb-3">
				<label class="form-label">Data:</label> <input type="date"
					name="dataPedido" class="form-control" />
			</div>
